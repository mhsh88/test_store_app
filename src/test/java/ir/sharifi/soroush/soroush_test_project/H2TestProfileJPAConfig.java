...
@EnableJpaRepositories(basePackages = {
        "ir.sharifi.soroush.soroush_test_project.food.repo",
        "ir.sharifi.soroush.soroush_test_project.detergent.repo",
        "ir.sharifi.soroush.soroush_test_project.user.repo",
})
...
public class H2TestProfileJPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "ir.sharifi.soroush.soroush_test_project" });
